...
// let unsubscribe = () => {
// };
// const mockItem = PostMocks.defaultPost;
// const mockItem2 = PostMocks.secondaryPost;
...
//         const testItem: Mutable<ItemInterface> = _.clone(PostMocks.defaultPost);
//         const testItem2: Mutable<ItemInterface> = _.clone(PostMocks.secondaryPost);
...
//     firestoreAdmin = stores.firestoreAdmin;
//
//     query = firestore.collection(COLLECTIONS.posts).doc(mockItem.id).withConverter(Converters.PostConverter);
//     queryAuthed = firestoreAuth.collection(COLLECTIONS.posts).doc(mockItem.id).withConverter(Converters.PostConverter);
//     queryAuthed2 = firestoreAuth2.collection(COLLECTIONS.posts).doc(mockItem2.id).withConverter(Converters.PostConverter);
